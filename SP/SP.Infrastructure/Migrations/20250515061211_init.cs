        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Feedback_OrderDetail_ProductVariantId_OrderId",
                        columns: x => new { x.ProductVariantId, x.OrderId },
            ...
            migrationBuilder.InsertData(
                table: "Discount",
                columns: new[] { "Id", "DateEnd", "DateStart", "Percent" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 10 },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 20 },
                    { 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 30 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, null, "admin@gmail.com", "admin", null, null, 1, "admin", null });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "AddressDetail", "DateOfBirth", "Email", "Password", "PasswordHash", "PhoneNumber", "UserName", "WardId" },
                values: new object[] { 2, null, null, "ngoc@gmail.com", "ngoc123", null, null, "Nguyen Bao Ngoc", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedback_ProductVariantId_OrderId",
                table: "Feedback",
